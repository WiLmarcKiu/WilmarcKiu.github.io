  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data T1A Kedatangan Domestik</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Data T1A Kedatangan Domestik</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <a href="tambaht1a_kedatangan_domestik.php" class="btn btn-sm btn-success"><i class="fa fa-plus" title="Tambah Penduduk"></i>&nbsp;Tambah Data</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <th>Pengawasan TS Kedatangan</th>
                  </tr>
                  </thead>
                  <tbody>
                    <?php $nomor = 1; ?>
                    <?php $ambil=$koneksi->query("SELECT * FROM t1dkedatangan");?>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="editta1kedatangandomes.php?id=<?php echo $pecah ['id_kedatangan']; ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit" title="Edit"></i></a>
                        <a href="hapus_t1akedatangandomestik.php?id=<?php echo $pecah ['id_kedatangan']; ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash-alt" title="Hapus"></i></a>
                        </div>
                      </td>
                      ...
                      <td><?php echo $pecah ['pengawasants_kedatangan']; ?></td>
                    </tr>
                    <?php $nomor++; ?>
                    <?php } ?>
                  </tbody>
