  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tambah Data T1A Kedatangan Domestik</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Tambah Data T1A Kedatangan Domestik</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                 ...
                 <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-4">
                      <input type="number" class="form-control" name="pengawasants_kedatangan">
                    </div>
                  </div>
                ...
                <?php 
                  if (isset($_POST['save']))
                  {
                    $koneksi->query ("INSERT INTO t1dkedatangan
                    (tanggal_kedatangan,jlhpesawat_kedatangan,pax_kedatangan,personil_kedatangan,pengawasants_kedatangan) VALUES ('$_POST[tanggal_kedatangan]','$_POST[jlhpesawat_kedatangan]','$_POST[pax_kedatangan]','$_POST[personil_kedatangan]','$_POST[pengawasants_kedatangan]')");
