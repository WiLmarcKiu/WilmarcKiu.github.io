  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tambah Data T1 Keberangkatan VIP Internasional</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Tambah Data T1 Keberangkatan VIP Internasional</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                 ...
                 <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <div class="col-md-2">
                      <label>Personil Keberagkatan</label>
                    </div>
                    <div class="col-md-4">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-4">
                      <input type="text" class="form-control" name="rincianpemeriksaan_dokvaksin">
                    </div>
                  </div>
                ...
                <?php 
                  if (isset($_POST['save']))
                  {
                    $koneksi->query ("INSERT INTO t1vipintlkeberangkatan
                    (tanggal_keberangkatan,jlhpesawat_keberangkatan,pax_keberangkatan,personil_keberangkatan,rincianpemeriksaan_dokvaksin) VALUES ('$_POST[tanggal_keberangkatan]','$_POST[jlhpesawat_keberangkatan]','$_POST[pax_keberangkatan]','$_POST[personil_keberangkatan]','$_POST[rincianpemeriksaan_dokvaksin]')");
