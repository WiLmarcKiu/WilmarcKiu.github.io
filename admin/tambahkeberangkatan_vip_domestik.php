  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tambah Data T1 Keberangkatan VIP Domestik</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Tambah Data T1 Keberangkatan VIP Domestik</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                 ...
                 <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-4">
                      <input type="number" class="form-control" name="ehac_pl">
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-4">
                      <input type="number" class="form-control" name="nonehac_manual">
                    </div>
                  </div>
                ...
                <?php 
                  if (isset($_POST['save']))
                  {
                    $koneksi->query ("INSERT INTO t1vipkeberangkatan
                    (tanggal_keberangkatan,jlhpesawat_keberangkatan,pax_keberangkatan,personil_keberangkatan,ehac_pl,nonehac_manual) VALUES ('$_POST[tanggal_keberangkatan]','$_POST[jlhpesawat_keberangkatan]','$_POST[pax_keberangkatan]','$_POST[personil_keberangkatan]','$_POST[ehac_pl]','$_POST[nonehac_manual]')");
