  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data T1A Keberangkatan Domestik</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Data T1A Keberangkatan Domestik</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <a href="tambaht1a_keberangkatan_domestik.php" class="btn btn-sm btn-success"><i class="fa fa-plus" title="Tambah Penduduk"></i>&nbsp;Tambah Data</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <th>Validasi Manual</th>
                    <th>Validasi Peduli Lindungi</th>
                    <th>Berobat Klinik</th>
                    <th>LT Hamil</th>
                    <th>LT Umum</th>
                    <th>TLT Hamil</th>
                    <th>TLT Umum</th>
                    <th>Rujuk Klinik</th>
                    <th>Laporan Kasus Covid-19</th>
                  ...
                  <tbody>
                    <?php $nomor = 1; ?>
                    <?php $ambil=$koneksi->query("SELECT * FROM t1keberangkatan");?>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="editta1keberangkatandomes.php?id=<?php echo $pecah ['id_keberangkatan']; ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit" title="Edit"></i></a>
                        <a href="hapus_t1akeberangkatandomestik.php?id=<?php echo $pecah ['id_keberangkatan']; ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash-alt" title="Hapus"></i></a>
                        </div>
                      </td>
                      ...
                      <td><?php echo $pecah ['validasimanual_keberangkatan']; ?></td>
                      <td><?php echo $pecah ['validasipl_keberangkatan']; ?></td>
                      <td><?php echo $pecah ['berobatklinik_keberangkatan']; ?></td>
                      <td><?php echo $pecah ['lthamil']; ?></td>
                      <td><?php echo $pecah ['ltumum']; ?></td>
                      <td><?php echo $pecah ['tlthamil']; ?></td>
                      <td><?php echo $pecah ['tltumum']; ?></td>
                      <td><?php echo $pecah ['rujukklinik']; ?></td>
                      <td><?php echo $pecah ['laporankasus_covid']; ?></td>
                      <td><?php echo $pecah ['jlhpetugas']; ?></td>
                      <td><?php echo $pecah ['relawanpagi']; ?></td>
                      <td><?php echo $pecah ['relawanmalam']; ?></td>
                      <td><?php echo $pecah ['dokpendukung']; ?></td>
                      <td><?php echo $pecah ['informasilain']; ?></td>
                    </tr>
                    <?php $nomor++; ?>
                    <?php } ?>
                  </tbody>
