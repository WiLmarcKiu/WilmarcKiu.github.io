...
include '../koneksi.php';
 ?>
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="logoedit.png" alt="AdminLTELogo" height="100" width="100">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      <img src="logoedit.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Admin | SIDeket</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="t1akedatangandomestik.php" class="nav-link">
                  <i class="fas fa-envelope-open-text nav-icon"></i>
                  <p>Terminal Kedatangan Domestik</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="t1akeberangkatan.php" class="nav-link">
                  <i class="fas fa-envelope-open-text nav-icon"></i>
                  <p>Terminal Keberangkatan Domestik </p>
                </a>
              </li>
              <li class="nav-item">
                <a href="terminalkedatangan_vip_domestik.php" class="nav-link">
                  <i class="fas fa-envelope-open-text nav-icon"></i>
                  <p>Terminal Kedatangan VIP Domestik</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="terminalkeberangkatan_vip_domestik.php" class="nav-link">
                  <i class="fas fa-envelope-open-text nav-icon"></i>
                  <p>Terminal Keberangkatan VIP Domestik</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="terminalkedatangan_vip_internasional.php" class="nav-link">
                  <i class="fas fa-envelope-open-text nav-icon"></i>
                  <p>Terminal Kedatangan VIP Internasional</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="terminalkeberangkatan_vip_internasional.php" class="nav-link">
                  <i class="fas fa-envelope-open-text nav-icon"></i>
                  <p>Terminal Keberangkatan VIP Internasional</p>
                </a>
              </li>
...
<!-- 
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="data_potensidesa.php" class="nav-link">
                  <i class="fas fa-envelope-open-text nav-icon"></i>
