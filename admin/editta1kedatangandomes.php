  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Data T1A Kedatangan Domestik</h1>
          </div>
          <div class="col-sm-6">
              ...
              <div class="card-body">
                <?php 
                 ...
                 <form method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                    <div class="col-md-2">
                      <label>Jumlah Pesawat Kedatangan</label>
                    </div>
                    <div class="col-md-4">
                  ...
                  <div class="form-group row">
                    <div class="col-md-2">
                      <label>Pengawasan TS Kedatangan</label>
                    </div>
                    <div class="col-md-4">
                      <input type="number" class="form-control" name="pengawasants_kedatangan" value="<?php echo $pecah ['pengawasants_kedatangan']; ?>">
                    </div>
                  </div>
                ...
                <?php 
                  if (isset($_POST['ubah'])) 
                  { 
                    $koneksi->query("UPDATE t1dkedatangan SET tanggal_kedatangan = '$_POST[tanggal_kedatangan]', jlhpesawat_kedatangan = '$_POST[jlhpesawat_kedatangan]',pax_kedatangan = '$_POST[pax_kedatangan]' ,personil_kedatangan = '$_POST[personil_kedatangan]',pengawasants_kedatangan = '$_POST[pengawasants_kedatangan]' WHERE id_kedatangan ='$_GET[id]'");
