  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Data T1 Keberangkatan VIP Domestik</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Edit Data T1 Keberangkatan VIP Domestik</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <?php 
                 ...
                 <form method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-4">
                      <input type="number" class="form-control" name="ehac_pl" value="<?php echo $pecah ['ehac_pl']; ?>">
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-2">
                      <label>Non eHAC / Validasi Manual</label>
                    </div>
                    <div class="col-md-4">
                      <input type="number" class="form-control" name="nonehac_manual" value="<?php echo $pecah ['nonehac_manual']; ?>">
                    </div>
                  </div>
                ...
                <?php 
                  if (isset($_POST['ubah'])) 
                  { 
                    $koneksi->query("UPDATE t1vipkeberangkatan SET tanggal_keberangkatan = '$_POST[tanggal_keberangkatan]', jlhpesawat_keberangkatan = '$_POST[jlhpesawat_keberangkatan]',pax_keberangkatan = '$_POST[pax_keberangkatan]' ,personil_keberangkatan = '$_POST[personil_keberangkatan]',ehac_pl = '$_POST[ehac_pl]',nonehac_manual = '$_POST[nonehac_manual]' WHERE id_keberangkatan ='$_GET[id]'");
