  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data T1 Keberangkatan VIP Internasional</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Data T1 Keberangkatan VIP Internasional</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <a href="tambahkeberangkatan_vip_internasional.php" class="btn btn-sm btn-success"><i class="fa fa-plus" title="Tambah Data"></i>&nbsp;Tambah Data</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <th>Rincian Pemeriksaan Dokumen Vaksin</th>
                  </tr>
                  </tr>
                  </thead>
                  <tbody>
                    <?php $nomor = 1; ?>
                    <?php $ambil=$koneksi->query("SELECT * FROM t1vipintlkeberangkatan");?>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="editkeberangkatan_vip_internasional.php?id=<?php echo $pecah ['id_keberangkatan']; ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit" title="Edit"></i></a>
                        <a href="hapuskeberangkatan_vip_internasional.php?id=<?php echo $pecah ['id_keberangkatan']; ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash-alt" title="Hapus"></i></a>
                        </div>
                      </td>
                      ...
                      <td><?php echo $pecah ['rincianpemeriksaan_dokvaksin']; ?></td>
                    </tr>
                    <?php $nomor++; ?>
                    <?php } ?>
                  </tbody>
