  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Data T1 Kedatangan VIP Domestik</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Edit Data T1 Kedatangan VIP Domestik</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <?php 
                 ...
                 <form method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-4">
                      <input type="number" class="form-control" name="jlhpersonil_kedatangan" value="<?php echo $pecah ['jlhpersonil_kedatangan']; ?>">
                    </div>
                  </div>
                ...
                <?php 
                  if (isset($_POST['ubah'])) 
                  { 
                    $koneksi->query("UPDATE t1vipkedatangan SET tanggal_kedatangan = '$_POST[tanggal_kedatangan]', jlhpesawat_kedatangan = '$_POST[jlhpesawat_kedatangan]',pax_kedatangan = '$_POST[pax_kedatangan]' ,jlhpersonil_kedatangan = '$_POST[jlhpersonil_kedatangan]'WHERE id_kedatangan ='$_GET[id]'");
