  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tambah Data Kedatangan T2 D-E Domestikk</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Tambah Data Kedatangan T2 D-E Domestik</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <?php 
                  if (isset($_POST['save']))
                  {
                    $koneksi->query ("INSERT INTO t2dekedatangan
                    (tanggal_kedatangan,jlhpesawat_kedatangan,pax_kedatangan,personil_kedatangan) VALUES ('$_POST[tanggal_kedatangan]','$_POST[jlhpesawat_kedatangan]','$_POST[pax_kedatangan]','$_POST[personil_kedatangan]')");
