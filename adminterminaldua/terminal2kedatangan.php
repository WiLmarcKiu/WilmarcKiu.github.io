  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Kedatangan T2 D-E Domestik</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Data Kedatangan T2 D-E Domestik</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php $nomor = 1; ?>
                    <?php $ambil=$koneksi->query("SELECT * FROM t2dekedatangan");?>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="edit_t2kedatangan.php?id=<?php echo $pecah ['id_kedatangan']; ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit" title="Edit"></i></a>
                        <a href="hapus_t2kedatangan.php?id=<?php echo $pecah ['id_kedatangan']; ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash-alt" title="Hapus"></i></a>
                        </div>
                      </td>
