  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Data Kedatangan T2 D-E Domestik</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Edit Data Kedatangan T2 D-E Domestik</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <?php 
                  if (isset($_POST['ubah'])) 
                  { 
                    $koneksi->query("UPDATE t2dekedatangan SET tanggal_kedatangan = '$_POST[tanggal_kedatangan]', jlhpesawat_kedatangan= '$_POST[jlhpesawat_kedatangan]',pax_kedatangan = '$_POST[pax_kedatangan]' ,personil_kedatangan = '$_POST[personil_kedatangan]' WHERE id_kedatangan ='$_GET[id]'");
