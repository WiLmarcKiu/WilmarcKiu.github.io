        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <?php 
                  $ambil= $koneksi->query("SELECT * FROM admintsatukedatangan");
                ...
                <?php 
                  ...
                  {
                    $koneksi->query("UPDATE admint1a SET username = '$_POST[username]',password = '$_POST[password]',email = '$_POST[email]',nama_lengkap = '$_POST[nama_lengkap]'");
