    ...
    <div class="card card-outline card-primary">
      ...
      <div class="card-body">
        ...
        <form action="cekLogin.php" method="post">
          ...
          <div class="input-group mb-3">
            <input type="password" class="form-control" placeholder="Password" name="password" autofocus="" required="" autocomplete="off">
            <div class="input-group-append">
              <div class="input-group-text">
          ...
          <div class="row mb-2">
            <!-- /.col -->
            <div class="col">
              <button type="submit" name="login" class="btn btn-primary btn-sm btn-block" style="border-radius: 20px;">Login</button>
            </div>
            <!-- /.col -->
          </div>
        </form>
